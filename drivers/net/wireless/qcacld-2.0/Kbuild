...
EXTRA_CFLAGS += -DSEC_READ_MACADDR
EXTRA_CFLAGS += -DSEC_READ_MACADDR_SYSFS
EXTRA_CFLAGS += -DSEC_CONFIG_PSM
EXTRA_CFLAGS += -DSEC_WRITE_VERSION_IN_SYSFS
EXTRA_CFLAGS += -DSEC_CONFIG_ANTENNA_CONTROL
EXTRA_CFLAGS += -DSEC_CONFIG_GRIP_POWER
EXTRA_CFLAGS += -DSEC_WRITE_SOFTAP_INFO_IN_SYSFS
ifeq ($(CONFIG_WLAN_SSR_ENABLED), y)
EXTRA_CFLAGS += -DWLAN_SSR_ENABLED
endif
endif
